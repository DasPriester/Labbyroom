...
public class OptionsMenu : MonoBehaviour
{
    ...
    readonly Dictionary<string, InputType> controlls = new Dictionary<string, InputType> {
        ...
        {"Build", InputType.KEY},
        {"PickUp", InputType.KEY},
        {"Hotbar Slot 1", InputType.KEY},
        {"Hotbar Slot 2", InputType.KEY},
        {"Hotbar Slot 3", InputType.KEY},
        {"Hotbar Slot 4", InputType.KEY},
        {"Hotbar Slot 5", InputType.KEY},
        {"Hotbar Slot 6", InputType.KEY},
        {"Hotbar Slot 7", InputType.KEY},
        {"Hotbar Slot 8", InputType.KEY},
        {"Hotbar Slot 9", InputType.KEY},
        {"Inventory", InputType.KEY},
        { "Menu",  InputType.KEY},
    };
